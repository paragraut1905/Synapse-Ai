...
rounded-md border border-gray-300' placeholder='The future of artificial
...
<div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
    {blogCategories.map((item)=>(
        ...
        className={`text-xs px-4 py-1 border rounded-full cursor-pointer ${selectedCategory === item ? 'bg-purple-50 text-purple-700' :
